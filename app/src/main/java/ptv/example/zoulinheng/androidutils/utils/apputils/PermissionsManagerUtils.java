...
public class PermissionsManagerUtils {
    ...
    private PermissionsManagerUtils(RxPermissions rxPermissions, OnPermissionsRequestResultListener resultListener) {
        this.rxPermissions = rxPermissions;
        this.resultListener = resultListener;
    }

    public static PermissionsManagerUtils setOnPermissionsRequestResultListener(RxPermissions rxPermissions, OnPermissionsRequestResultListener onPermissionsRequestResultListener) {
        return new PermissionsManagerUtils(rxPermissions, onPermissionsRequestResultListener);
    }
    ...
    public static String[] getNeedToAskPermissionArray(Context context, String... permissions) {
        ...
        String[] deniedPers = PermissionsManagerUtils.getDeniedPermissions(context, permissions);
     ...
     * @return
     */
    private static boolean hasUnDeniedPermission(Context context, String... deniedPermissions) {
